        ...
        <div class="tw-flex tw-relative tw-justify-between tw-items-center tw-min-h-screen tw-text-white">
            <div class="tw-flex-1 tw-p-9 tw-z-7">
                <h1 class="tw-text-4xl md:tw-text-7xl tw-font-bold ">
                    ...
                    <span class="md:tw-text-6xl tw-text-4xl tw-leading-tight tw-inline-flex tw-h-16 md:tw-h-24 tw-pt-2 tw-overflow-x-hidden tw-animate-type tw-animate-type-reverse tw-whitespace-nowrap tw-text-brand-accent tw-will-change-transform">
                        Nguyễn Quang Đăng
                    </span>
                    <span class="tw-box-border tw-inline-block tw-w-1 tw-h-12 tw-bg-white md:tw-h-16 tw-animate-cursor tw-will-change-transform">
                    </span>
                </h1>
            ...
            <div class="tw-flex-1 tw-absolute tw-right-0 tw-z-0 tw-bottom-0 lg:tw-relative tw-h-full">
